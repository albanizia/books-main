...
<script src = "criar-livros.js"></script>
</head>
<body>
    <header class="p-relative">
        ...
        <h1> <?= "Books" ?> </h1>
        <h2> <?php echo "Os mais temidos";?> </h2>
    </header>
    <main>
        <form action="" class="form-inline">
            <div class="form-group">
                ...
                <input type="button" value="Salvar"
                    class="btn btn-primary" onclick="criarHTML('#txt_livro')">
            </div>
        </form>
        <div id="sessaoLivros">
            <?php 
            ...
            $todosDados = Conexao::getData();
            foreach($todosDados as $livro):
            ?>
